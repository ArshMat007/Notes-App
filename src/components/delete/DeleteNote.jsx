...
import { RestoreFromTrashOutlined as Restore, DeleteForeverOutlined as Delete, LabelOutlined as Label } from '@mui/icons-material';
import { DataContext } from "../../context/DataProvider";

const DeleteNote = ({ note }) => {
  const { restoreNote, removeNote, updateNoteLabels, labels, addLabel } = useContext(DataContext);
  ...
  return (
    <Card className="note-card">
      ...
      <CardActions>
        ...
        <IconButton style={{ marginLeft: "auto" }} onClick={(e) => {e.stopPropagation();removeNote(note)}}>
        <Delete fontSize="small" />
        </IconButton>
        <IconButton onClick={(e) => {e.stopPropagation();restoreNote(note)}}>
